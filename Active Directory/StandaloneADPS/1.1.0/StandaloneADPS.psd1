...
Description = "Standalone version of the integrated Active Directory RSAT PowerShell module."
...
RootModule = "Microsoft.ActiveDirectory.Management.dll"
...
NestedModules = @('ConnectToAd.psm1')
FunctionsToExport = @('Connect-ToAD', 'Disconnect-FromAD')
VariablesToExport = 'PSDefaultParameterValues'
CmdletsToExport=
